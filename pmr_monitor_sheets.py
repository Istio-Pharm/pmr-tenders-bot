...
def log_to_sheets(tender_id, subject, price):
    try:
        ...
        creds = ServiceAccountCredentials.from_json_keyfile_name('pmr-tenders-bot-ca187369504f.json', scope)
        client = gspread.authorize(creds)
        sheet = client.open_by_key("1KJcufLBYkhfPh5gRSJkAT3fsiiJ_X28_itqq7Ijrf9g").sheet1
